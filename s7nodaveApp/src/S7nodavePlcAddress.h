#ifndef S7nodavePlcAddress_h
#define S7nodavePlcAddress_h
...
public:
     ...
     */
    static boost::optional<s7nodavePlcArea> stringToArea(std::string areaString);
     ...
     */
    static boost::optional<s7nodavePlcDataSize> stringToDataSize(std::string dataSizeString, bool isDB);
     ...
     */
    static boost::optional<S7nodavePlcAddress> create(s7nodavePlcArea area, int areaNumber, s7nodavePlcDataSize dataSize, int startByte, int startBit);
     ...
     */
    static boost::optional<S7nodavePlcAddress> create(std::string addressString);
...
protected:
     ...
     */
    S7nodavePlcAddress(s7nodavePlcArea area, int areaNumber, s7nodavePlcDataSize, int startByte, char startBit);
