#ifndef S7nodaveStringSupport_h
#define S7nodaveStringSupport_h
...
public:
     ...
     */
    static boost::optional<s7nodavePlcDataType> getPlcDataType(S7nodavePlcAddress plcAddress, boost::optional<s7nodavePlcDataType> userRequestedType);
